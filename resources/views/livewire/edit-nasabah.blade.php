                ...
                <div class="control @error('pekerjaan') has-icons-left @enderror">
                    <div class="select is-fullwidth @error('pekerjaan') is-danger @enderror">
                        <select id="pekerjaan" name="pekerjaan">
                            ...
                            <option value="75"
                                {{ $datanasabah->detailNasabah->pekerjaan == 75 ? 'selected' : null }}>
                                Pengusaha / Wiraswasta
                            </option>
                            <option value="50"
                                {{ $datanasabah->detailNasabah->pekerjaan == 50 ? 'selected' : null }}>
                                Karyawan Swasta (Tetap)
                            </option>
                            <option value="20"
                                {{ $datanasabah->detailNasabah->pekerjaan == 20 ? 'selected' : null }}>
                                Karyawan Swasta (Lepas)
                            </option>
                            <option value="0"
                                {{ $datanasabah->detailNasabah->pekerjaan == 0 ? 'selected' : null }}>
                                Tidak Bekerja
                            </option>
                        </select>
                    </div>
